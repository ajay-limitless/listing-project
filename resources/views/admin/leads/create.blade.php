            ...
            <div class="row mr-2 ml-2">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select w-100 p-2 border border-light-subtle rounded-1" aria-label="Default select example" style="border-radius: 5px; " name="property_type">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="toggle-button">
                            <input type="checkbox" id="toggle" class="toggle-input" name="status">
